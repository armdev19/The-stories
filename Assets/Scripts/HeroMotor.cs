...
public class HeroMotor : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        // Rotate the Hero to where he is going
    ...
    private void StartSliding()
    {
        ...
        controller.center = new Vector3(controller.center.x, controller.center.y / 2.2f, controller.center.z);
    }
